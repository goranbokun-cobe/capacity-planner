    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50">
      <div className="w-full max-w-sm rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-xl font-semibold text-gray-900">COBE Capacity Planner</h1>
          <p className="mt-1 text-sm text-gray-500">Sign in with your COBE Google account</p>
        </div>
        ...
        {error && (
          <div className="mb-4 rounded-lg bg-red-50 px-4 py-3 text-sm text-red-700">
            {error === "AccessDenied"
              ? "Access denied — only @cobeisfresh.com accounts are allowed."
